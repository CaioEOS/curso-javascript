function calc() {
  ...
  switch (
    op // A estrutura switch basicamente permite você testar valores dentro de uma variável ou expressão. Ela é compatível apenas com números inteiros e strings
  ) {
    case 1:
    ...
    case 3:
      ...
      break;
    case 4:
      saida.innerHTML += `<p>${n1} / ${n2} = <strong>${(n1 / n2).toLocaleString(
        "pt-BR"
      )}</strong></p>`; // O método toLocaleString() é muito útil para mostrar números de forma mais compatível com o que usamos aqui no Brasil.
      break;
